...
public class Game {
    ...
    public void CeruleanCity(){
        ...
        mainTextArea.setText("-------------------------------------------------------\n" + 
                             "You are currently in Cerulean City:\n" + 
                             "-------------------------------------------------------\n" + 
                             "[1] Move to:\r\n" + //
                             " a.Saffron City b.Lavender Town c.Vermillion City d.Celadon City\n"+ //
                             "[2] Challenge Gym leader [Sabrina- Psychic type]\r\n" + //
                             "[3] Fight Wild Pokemon\r\n" + //
                             "[4] Player Options\r\n" + //
                             " a.Show map b.Show My Pokemon c.Show My badges d.Save and Exit\r\n" + //
    ...
    public void LavenderTown(){
        ...
        mainTextArea.setText("-------------------------------------------------------\n" + 
                             ...
                             "-------------------------------------------------------\n" + 
                             "[1] Move to:\r\n" + //
                             " a.Cerulean City b.Saffron City c.Vermillion City d.Celadon City\n"+ //
                             "[2] Challenge Gym leader [Sabrina- Psychic type]\r\n" + //
                             "[3] Fight Wild Pokemon\r\n" + //
                             "[4] Player Options\r\n" + //
                             " a.Show map b.Show My Pokemon c.Show My badges d.Save and Exit\r\n" + //
    ...
    public void VermillionCity(){
        ...
        mainTextArea.setText("-------------------------------------------------------\n" + 
                             "You are currently in Vermillion City:\n" + 
                             "-------------------------------------------------------\n" + 
                             "[1] Move to:\r\n" + //
                             " a.Cerulean City b.Lavender Town c.Saffron City d.Celadon City\n"+ //
                             "[2] Challenge Gym leader [Sabrina- Psychic type]\r\n" + //
                             "[3] Fight Wild Pokemon\r\n" + //
                             "[4] Player Options\r\n" + //
                             " a.Show map b.Show My Pokemon c.Show My badges d.Save and Exit\r\n" + //
    ...
    public void CeladonCity(){
        ...
        mainTextArea.setText("-------------------------------------------------------\n" + 
                             ...
                             "-------------------------------------------------------\n" + 
                             "[1] Move to:\r\n" + //
                             " a.Cerulean City b.Lavender Town c.Vermillion City d.Saffron City\n"+ //
                             "[2] Challenge Gym leader [Sabrina- Psychic type]\r\n" + //
                             "[3] Fight Wild Pokemon\r\n" + //
                             "[4] Player Options\r\n" + //
                             " a.Show map b.Show My Pokemon c.Show My badges d.Save and Exit\r\n" + //
    ...
    public void choice1(){
        ...
        ch1Button.setText("Cerulean City");
        ch2Button.setText("Lavender Town");
        ch3Button.setText("Vermillion City");
        ch4Button.setText("Celadon City");
        ch5Button.setText("<");
