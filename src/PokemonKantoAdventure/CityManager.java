...
public class CityManager extends HashMap<String, City>
{
    ...
    {
        cities.put("Pallet Town", new City("Pallet Town", Arrays.asList("Viridian City", "Cinnabar Island"), "", "", Arrays.asList("Pidgey", "Meowth", "Sycther")));
        ...
        cities.put("Fuschia City", new City("Fuschia City", Arrays.asList("Cinnabar Island", "Celadon City", "Lavender Town", "Vermillion City"), "Koga", "Poison", Arrays.asList("A", "B")));
